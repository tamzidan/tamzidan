...
import { renderSocialIcon } from '@/utils/iconMapping';
                                ...
                                >
                                    {isLoadingSocial ? (
                                        ...
                                        socialLinks.map((social, index) => (
                                            ...
                                            >
                                                {renderSocialIcon(social.icon, 'h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-gray-300')}
                                            </a>
                                        ))
                                    ) : null}
                                </motion.div>
